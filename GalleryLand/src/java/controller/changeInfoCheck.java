 ...
 * @author macbookair
 */
public class changeInfoCheck extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            } else //login fail
            {
                ...
                request.setAttribute("changeStatus", "fail");
                request.getRequestDispatcher("changeInfoCheck.jsp").forward(request, response);
            }
        }
    }
